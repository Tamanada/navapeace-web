...
// 13 languages: EN FR ES PT DE AR ZH RU TH JA MY HI UK
...
const NAVA_TRANSLATIONS = {
  ...
  en: {
    ...
    stats_leaderboard:  '🏆 TOP PEACE LOVERS',
    // Registration
    lbl_country:        'Country',
    lbl_age:            'Age',
    lbl_gender:         'Gender',
    ...
    save_btn:           'SAVE',
    close_btn:          'CLOSE',
    id_info_visible_title: 'VISIBLE BY EVERYONE',
    id_info_visible_body:  'Your pseudo is your public name. All NAVA PEACE members can see it in the peace messages and on the map.',
    id_info_msg_title:     'PEACE MESSAGES',
    id_info_msg_body:      'When you share a peace message, it appears with your pseudo next to it on the world map.',
    id_info_invite_title:  'INVITE & SHARE',
    id_info_invite_body:   'Your pseudo appears when you invite friends. You can change it once at any time.',
    copied_lbl:         '✓ COPIED',
    ...
    mission_p1:         'NAVA PEACE is a global daily movement. Every day, people from every country make one simple commitment: <strong>To choose peace.</strong>',
    ...
    // Map popovers & streak
    personal_streak:    'YOU HAVE CHOSEN PEACE<br>{days} DAY(S) IN A ROW',
    ...
    market_error: 'FAILED TO LOAD PRODUCTS.',
    // Streak & share
    streak_title:        'PEACE STREAK',
    streak_days_row:     'DAYS IN A ROW',
    streak_days_unit:    'DAYS',
    streak_seedling:     'SEEDLING',
    streak_keeper:       'KEEPER',
    streak_warrior:      'WARRIOR',
    streak_champion:     'CHAMPION',
    streak_legend:       'LEGEND',
  ...
  fr: {
    ...
    nav_stats:          'STATS',
    nav_market:         'MARCHÉ',
    stats_tagline:      'STATS GLOBALES',
    stats_overview:     'VUE D\'ENSEMBLE',
    stats_total_votes:  'VOTES TOTAUX',
    stats_today:        'AUJOURD\'HUI',
    stats_countries:    'PAYS',
    stats_users:        'UTILISATEURS',
    stats_top_countries:'TOP PAYS',
    stats_leaderboard:  '🏆 TOP ARTISANS DE PAIX',
    lbl_country:        'Pays',
    lbl_age:            'Âge',
    lbl_gender:         'Genre',
    ...
    close_btn:          'FERMER',
    id_info_visible_title: 'VISIBLE PAR TOUS',
    id_info_visible_body:  'Ton pseudo est ton nom public. Tous les membres NAVA PEACE peuvent le voir dans les messages de paix et sur la carte.',
    id_info_msg_title:     'MESSAGES DE PAIX',
    id_info_msg_body:      'Quand tu partages un message de paix, il apparaît avec ton pseudo sur la carte du monde.',
    id_info_invite_title:  'INVITER & PARTAGER',
    id_info_invite_body:   'Ton pseudo apparaît quand tu invites des amis. Tu peux le changer une fois à tout moment.',
    copied_lbl:         '✓ COPIÉ',
    ...
    mission_p1:         "NAVA PEACE est un mouvement mondial quotidien. Chaque jour, des personnes de tous les pays prennent un engagement simple : <strong>Choisir la paix.</strong>",
    ...
    personal_streak:    "VOUS AVEZ CHOISI LA PAIX<br>{days} JOUR(S) D'AFFILÉE",
    ...
    press_hint:          'APPUYEZ\nPOUR CHOISIR\nLA PAIX',
    next_action_in:      'PROCHAINE ACTION DANS',
    tap_to_see_map:      'VOIR\nLA CARTE',
    btn_thank_you:       'MERCI',
    btn_peace_lover:     'AMOUREUX DE LA PAIX',
    remind_btn:          '🔔 RAPPEL',
    remind_sent:         '✓ ENVOYÉ',
    reminder_banner:     "Un ami t'invite à choisir la paix aujourd'hui !",
    nav_market:   'BOUTIQUE',
    market_tagline:'BOUTIQUE DE LA PAIX',
    market_search:'RECHERCHER…',
    market_from:  'DÈS',
    market_buy:   '🛍 ACHETER',
    market_prev:  '← PRÉC',
    market_next:  'SUIV →',
    market_empty: 'AUCUN PRODUIT TROUVÉ.',
    market_error: 'ÉCHEC DU CHARGEMENT.',
    streak_title:        'SÉRIE DE PAIX',
    streak_days_row:     "JOURS D'AFFILÉE",
    streak_days_unit:    'JOURS',
    streak_seedling:     'GRAINE',
    streak_keeper:       'GARDIEN',
    streak_warrior:      'GUERRIER',
    streak_champion:     'CHAMPION',
    streak_legend:       'LÉGENDE',
  ...
  es: {
    ...
    nav_stats:          'STATS',
    nav_market:         'TIENDA',
    stats_tagline:      'ESTADÍSTICAS GLOBALES',
    stats_overview:     'RESUMEN',
    stats_total_votes:  'VOTOS TOTALES',
    stats_today:        'HOY',
    stats_countries:    'PAÍSES',
    stats_users:        'USUARIOS',
    stats_top_countries:'TOP PAÍSES',
    stats_leaderboard:  '🏆 TOP AMANTES DE LA PAZ',
    lbl_country:        'País',
    lbl_age:            'Edad',
    lbl_gender:         'Género',
    ...
    save_btn:           'GUARDAR',
    close_btn:          'CERRAR',
    id_info_visible_title: 'VISIBLE PARA TODOS',
    id_info_visible_body:  'Tu seudónimo es tu nombre público. Todos los miembros de NAVA PEACE pueden verlo en los mensajes de paz y en el mapa.',
    id_info_msg_title:     'MENSAJES DE PAZ',
    id_info_msg_body:      'Cuando compartes un mensaje de paz, aparece con tu seudónimo en el mapa mundial.',
    id_info_invite_title:  'INVITAR Y COMPARTIR',
    id_info_invite_body:   'Tu seudónimo aparece cuando invitas amigos. Puedes cambiarlo una vez en cualquier momento.',
    copied_lbl:         '✓ COPIADO',
    ...
    mission_p1:         'NAVA PEACE es un movimiento global diario. Cada día, personas de todos los países asumen un compromiso simple: <strong>Elegir la paz.</strong>',
    ...
    // Popovers mapa & racha
    personal_streak:    'HAS ELEGIDO LA PAZ<br>{days} DÍA(S) SEGUIDO(S)',
    ...
    press_hint:          'PRESIONA\nPARA ELEGIR\nLA PAZ',
    next_action_in:      'PRÓXIMA ACCIÓN EN',
    tap_to_see_map:      'VER\nEL MAPA',
    btn_thank_you:       'GRACIAS',
    btn_peace_lover:     'AMANTE DE LA PAZ',
    remind_btn:          '🔔 RECORDAR',
    remind_sent:         '✓ ENVIADO',
    reminder_banner:     '¡Un amigo te invita a elegir la paz hoy!',
    nav_market:   'TIENDA',
    market_tagline:'TIENDA DE LA PAZ',
    market_search:'BUSCAR…',
    market_from:  'DESDE',
    market_buy:   '🛍 COMPRAR',
    market_prev:  '← ANT',
    market_next:  'SIG →',
    market_empty: 'SIN PRODUCTOS.',
    market_error: 'ERROR AL CARGAR.',
    streak_title:        'RACHA DE PAZ',
    streak_days_row:     'DÍAS SEGUIDOS',
    streak_days_unit:    'DÍAS',
    streak_seedling:     'SEMILLA',
    streak_keeper:       'GUARDIÁN',
    streak_warrior:      'GUERRERO',
    streak_champion:     'CAMPEÓN',
  ...
  pt: {
    ...
    nav_stats:          'STATS',
    nav_market:         'LOJA',
    stats_tagline:      'ESTATÍSTICAS GLOBAIS',
    stats_overview:     'VISÃO GERAL',
    stats_total_votes:  'VOTOS TOTAIS',
    stats_today:        'HOJE',
    stats_countries:    'PAÍSES',
    stats_users:        'UTILIZADORES',
    stats_top_countries:'TOP PAÍSES',
    stats_leaderboard:  '🏆 TOP AMANTES DA PAZ',
    lbl_country:        'País',
    lbl_age:            'Idade',
    lbl_gender:         'Gênero',
    ...
    save_btn:           'SALVAR',
    close_btn:          'FECHAR',
    id_info_visible_title: 'VISÍVEL POR TODOS',
    id_info_visible_body:  'Seu apelido é seu nome público. Todos os membros do NAVA PEACE podem vê-lo nas mensagens de paz e no mapa.',
    id_info_msg_title:     'MENSAGENS DE PAZ',
    id_info_msg_body:      'Quando você compartilha uma mensagem de paz, ela aparece com seu apelido no mapa mundial.',
    id_info_invite_title:  'CONVIDAR E COMPARTILHAR',
    id_info_invite_body:   'Seu apelido aparece quando você convida amigos. Você pode alterá-lo uma vez a qualquer momento.',
    copied_lbl:         '✓ COPIADO',
    ...
    mission_p1:         'NAVA PEACE é um movimento global diário. Cada dia, pessoas de todos os países assumem um compromisso simples: <strong>Escolher a paz.</strong>',
    ...
    personal_streak:    'VOCÊ ESCOLHEU A PAZ<br>{days} DIA(S) SEGUIDO(S)',
    ...
    next_action_in:      'PRÓXIMA AÇÃO EM',
    tap_to_see_map:      'VER\nO MAPA',
    btn_thank_you:       'OBRIGADO',
    btn_peace_lover:     'AMANTE DA PAZ',
    remind_btn:          '🔔 LEMBRAR',
    remind_sent:         '✓ ENVIADO',
    reminder_banner:     'Um amigo te convida a escolher a paz hoje!',
    nav_market:   'LOJA',
    market_tagline:'LOJA DA PAZ',
    market_search:'PESQUISAR…',
    market_from:  'DE',
    market_buy:   '🛍 COMPRAR',
    market_prev:  '← ANT',
    market_next:  'PROX →',
    market_empty: 'SEM PRODUTOS.',
    market_error: 'FALHA AO CARREGAR.',
    streak_title:        'SEQUÊNCIA DE PAZ',
    streak_days_row:     'DIAS SEGUIDOS',
    streak_days_unit:    'DIAS',
    streak_seedling:     'SEMENTE',
    streak_keeper:       'GUARDIÃO',
    streak_warrior:      'GUERREIRO',
    streak_champion:     'CAMPEÃO',
    streak_legend:       'LENDA',
  ...
  de: {
    ...
    nav_stats:          'STATS',
    nav_market:         'MARKT',
    stats_tagline:      'GLOBALE STATISTIKEN',
    stats_overview:     'ÜBERSICHT',
    stats_total_votes:  'GESAMTSTIMMEN',
    stats_today:        'HEUTE',
    stats_countries:    'LÄNDER',
    stats_users:        'NUTZER',
    stats_top_countries:'TOP LÄNDER',
    stats_leaderboard:  '🏆 TOP FRIEDENSLIEBENDE',
    lbl_country:        'Land',
    lbl_age:            'Alter',
    ...
    id_info_visible_title: 'FÜR ALLE SICHTBAR',
    id_info_visible_body:  'Dein Pseudo ist dein öffentlicher Name. Alle NAVA PEACE-Mitglieder können ihn in den Friedensbotschaften und auf der Karte sehen.',
    id_info_msg_title:     'FRIEDENSBOTSCHAFTEN',
    id_info_msg_body:      'Wenn du eine Friedensbotschaft teilst, erscheint sie mit deinem Pseudo auf der Weltkarte.',
    id_info_invite_title:  'EINLADEN & TEILEN',
    id_info_invite_body:   'Dein Pseudo erscheint, wenn du Freunde einlädst. Du kannst es einmal jederzeit ändern.',
    copied_lbl:         '✓ KOPIERT',
    ...
    firstname_change_btn: 'BEARBEITEN',
    ...
    mission_p1:         'NAVA PEACE ist eine globale tägliche Bewegung. Jeden Tag treffen Menschen aus allen Ländern eine einfache Entscheidung: <strong>Frieden zu wählen.</strong>',
    ...
    personal_streak:    'DU HAST FRIEDEN GEWÄHLT<br>{days} TAG(E) IN FOLGE',
    ...
    press_hint:          'DRÜCKEN\nFÜR DEN\nFRIEDEN',
    next_action_in:      'NÄCHSTE AKTION IN',
    tap_to_see_map:      'KARTE\nANZEIGEN',
    btn_thank_you:       'DANKE',
    btn_peace_lover:     'FRIEDENSLIEBHABER',
    remind_btn:          '🔔 ERINNERN',
    remind_sent:         '✓ GESENDET',
    reminder_banner:     'Ein Freund lädt dich ein, heute Frieden zu wählen!',
    nav_market:   'SHOP',
    market_tagline:'FRIEDENS-SHOP',
    market_search:'SUCHEN…',
    market_from:  'AB',
    market_buy:   '🛍 KAUFEN',
    market_prev:  '← VOR',
    market_next:  'WEITER →',
    market_empty: 'KEINE PRODUKTE.',
    market_error: 'LADEFEHLER.',
    streak_title:        'FRIEDENSSERIE',
    streak_days_row:     'TAGE IN FOLGE',
    streak_days_unit:    'TAGE',
    streak_seedling:     'SÄMLING',
    streak_keeper:       'HÜTER',
    streak_warrior:      'KRIEGER',
    streak_champion:     'CHAMPION',
    streak_legend:       'LEGENDE',
  ...
  ar: {
    ...
    save_btn:           'حفظ',
    close_btn:          'إغلاق',
    id_info_visible_title: 'مرئي للجميع',
    id_info_visible_body:  'اسمك المستعار هو اسمك العام. يمكن لجميع أعضاء NAVA PEACE رؤيته في رسائل السلام وعلى الخريطة.',
    id_info_msg_title:     'رسائل السلام',
    id_info_msg_body:      'عندما تشارك رسالة سلام، تظهر مع اسمك المستعار على الخريطة العالمية.',
    id_info_invite_title:  'الدعوة والمشاركة',
    id_info_invite_body:   'يظهر اسمك المستعار عند دعوة الأصدقاء. يمكنك تغييره مرة واحدة في أي وقت.',
    copied_lbl:         '✓ تم النسخ',
    ...
    mission_lbl:        'مهمتنا',
    mission_p1:         'NAVA PEACE حركة يومية عالمية. كل يوم، يتخذ أشخاص من كل دولة التزامًا بسيطًا: <strong>اختيار السلام.</strong>',
    ...
    personal_streak:    'اخترت السلام<br>{days} يوم/أيام متتالية',
    ...
    press_hint:          'اضغط\nلاختيار\nالسلام',
    next_action_in:      'الإجراء التالي في',
    tap_to_see_map:      'اضغط لرؤية\nالخريطة',
    btn_thank_you:       'شكراً لك',
    btn_peace_lover:     'محب السلام',
    remind_btn:          '🔔 تذكير',
    remind_sent:         '✓ أُرسل',
    reminder_banner:     'صديق يدعوك لاختيار السلام اليوم!',
    nav_market:   'متجر',
    market_tagline:'متجر السلام',
    market_search:'بحث…',
    market_from:  'من',
    market_buy:   '🛍 شراء',
    market_prev:  'السابق ←',
    ...
    market_error: 'فشل التحميل.',
    streak_title:        'سلسلة السلام',
    streak_days_row:     'أيام متتالية',
    streak_days_unit:    'أيام',
    streak_seedling:     'بذرة',
    streak_keeper:       'حارس',
    streak_warrior:      'محارب',
    streak_champion:     'بطل',
    streak_legend:       'أسطورة',
  ...
  zh: {
    ...
    stats_tagline:      '全球统计',
    stats_overview:     '概览',
    stats_total_votes:  '总票数',
    stats_today:        '今天',
    stats_countries:    '国家',
    stats_users:        '用户',
    stats_top_countries:'热门国家',
    stats_leaderboard:  '🏆 顶级爱好和平者',
    lbl_country:        '国家',
    lbl_age:            '年龄',
    lbl_gender:         '性别',
    ph_country:         '选择您的国家',
    ...
    save_btn:           '保存',
    close_btn:          '关闭',
    id_info_visible_title: '所有人可见',
    id_info_visible_body:  '你的昵称是你的公开名称。所有NAVA PEACE成员都可以在和平消息和地图上看到它。',
    id_info_msg_title:     '和平消息',
    id_info_msg_body:      '当你分享和平消息时，它会与你的昵称一起显示在世界地图上。',
    id_info_invite_title:  '邀请与分享',
    id_info_invite_body:   '邀请朋友时会显示你的昵称。你可以随时更改一次。',
    copied_lbl:         '✓ 已复制',
    popup_my_doves:     '我的鸽子',
    popup_own_lbl:      '自己的行动',
    popup_ref_lbl:      '推荐',
    ...
    about_tagline:      '关于运动',
    mission_lbl:        '我们的使命',
    mission_p1:         'NAVA PEACE 是一个全球日常运动。 每天，来自每个国家的人们 做出一个简单的承诺： <strong>选择和平。</strong>',
    ...
    // 地图弹窗和连续记录
    personal_streak:    '您已选择和平<br>连续{days}天',
    ...
    press_hint:          '按下\n选择\n和平',
    next_action_in:      '下次行动倒计时',
    tap_to_see_map:      '点击查看\n地图',
    btn_thank_you:       '谢谢你',
    btn_peace_lover:     '和平爱好者',
    remind_btn:          '🔔 提醒',
    remind_sent:         '✓ 已发送',
  ...
  ru: {
    ...
    nav_market:         'МАГАЗИН',
    stats_tagline:      'ГЛОБАЛЬНАЯ СТАТИСТИКА',
    stats_overview:     'ОБЗОР',
    stats_total_votes:  'ВСЕГО ГОЛОСОВ',
    stats_today:        'СЕГОДНЯ',
    stats_countries:    'СТРАНЫ',
    stats_users:        'ПОЛЬЗОВАТЕЛИ',
    stats_top_countries:'ТОП СТРАНЫ',
    stats_leaderboard:  '🏆 ТОП МИРОЛЮБИВЫХ',
    lbl_country:        'Страна',
    lbl_age:            'Возраст',
    lbl_gender:         'Пол',
    ...
    save_btn:           'СОХРАНИТЬ',
    close_btn:          'ЗАКРЫТЬ',
    id_info_visible_title: 'ВИДНО ВСЕМ',
    id_info_visible_body:  'Ваш псевдоним — это ваше публичное имя. Все члены NAVA PEACE видят его в мирных посланиях и на карте.',
    id_info_msg_title:     'МИРНЫЕ ПОСЛАНИЯ',
    id_info_msg_body:      'Когда вы делитесь мирным посланием, оно появляется с вашим псевдонимом на карте мира.',
    id_info_invite_title:  'ПРИГЛАСИТЬ И ПОДЕЛИТЬСЯ',
    id_info_invite_body:   'Ваш псевдоним отображается при приглашении друзей. Вы можете изменить его один раз в любое время.',
    ...
    mission_p1:         'NAVA PEACE — ежедневное глобальное движение. Каждый день люди из всех стран берут на себя простое обязательство: <strong>Выбрать мир.</strong>',
    ...
    personal_streak:    'ВЫ ВЫБИРАЕТЕ МИР<br>{days} ДЕНЬ(ДНЕЙ) ПОДРЯД',
    ...
    press_hint:          'НАЖМИТЕ\nЧТОБЫ ВЫБРАТЬ\nМИР',
    next_action_in:      'СЛЕДУЮЩЕЕ ДЕЙСТВИЕ ЧЕРЕЗ',
    tap_to_see_map:      'НАЖМИТЕ ДЛЯ\nКАРТЫ',
    btn_thank_you:       'СПАСИБО',
    btn_peace_lover:     'ЛЮБИТЕЛЬ МИРА',
    remind_btn:          '🔔 НАПОМНИТЬ',
    remind_sent:         '✓ ОТПРАВЛЕНО',
    reminder_banner:     'Друг приглашает тебя выбрать мир сегодня!',
    nav_market:   'МАГАЗИН',
    market_tagline:'МАГАЗИН МИРА',
    market_search:'ПОИСК…',
    market_from:  'ОТ',
    market_buy:   '🛍 КУПИТЬ',
    market_prev:  '← ПРЕД',
    ...
    market_error: 'ОШИБКА ЗАГРУЗКИ.',
    streak_title:        'СЕРИЯ МИРА',
    streak_days_row:     'ДНЕЙ ПОДРЯД',
    streak_days_unit:    'ДНЕЙ',
    streak_seedling:     'РОСТОК',
    streak_keeper:       'ХРАНИТЕЛЬ',
    streak_warrior:      'ВОИН',
    streak_champion:     'ЧЕМПИОН',
    streak_legend:       'ЛЕГЕНДА',
  ...
  th: {
    ...
    nav_stats:          'สถิติ',
    nav_market:         'ร้านค้า',
    stats_tagline:      'สถิติทั่วโลก',
    stats_overview:     'ภาพรวม',
    stats_total_votes:  'โหวตทั้งหมด',
    stats_today:        'วันนี้',
    stats_countries:    'ประเทศ',
    stats_users:        'ผู้ใช้',
    stats_top_countries:'ประเทศยอดนิยม',
    stats_leaderboard:  '🏆 ผู้รักสันติสูงสุด',
    lbl_country:        'ประเทศ',
    lbl_age:            'อายุ',
    lbl_gender:         'เพศ',
    ...
    save_btn:           'บันทึก',
    close_btn:          'ปิด',
    id_info_visible_title: 'มองเห็นได้โดยทุกคน',
    id_info_visible_body:  'ชื่อเล่นของคุณคือชื่อสาธารณะ สมาชิก NAVA PEACE ทุกคนสามารถเห็นในข้อความสันติภาพและบนแผนที่',
    id_info_msg_title:     'ข้อความสันติภาพ',
    id_info_msg_body:      'เมื่อคุณแชร์ข้อความสันติภาพ จะปรากฏพร้อมชื่อเล่นของคุณบนแผนที่โลก',
    id_info_invite_title:  'เชิญและแชร์',
    id_info_invite_body:   'ชื่อเล่นของคุณจะปรากฏเมื่อคุณเชิญเพื่อน คุณสามารถเปลี่ยนได้หนึ่งครั้งตลอดเวลา',
    ...
    firstname_label:    'ชื่อจริง',
    firstname_change_btn: 'แก้ไข',
    ...
    mission_p1:         'NAVA PEACE คือขบวนการประจำวันระดับโลก ทุกวัน ผู้คนจากทุกประเทศ ทำคำมั่นสัญญาที่เรียบง่าย: <strong>เลือกสันติภาพ</strong>',
    ...
    personal_streak:    'คุณเลือกสันติภาพ<br>มาแล้ว {days} วันติดต่อกัน',
    ...
    press_hint:          'กด\nเพื่อเลือก\nสันติภาพ',
    next_action_in:      'การกระทำถัดไปใน',
    tap_to_see_map:      'แตะเพื่อดู\nแผนที่',
    btn_thank_you:       'ขอบคุณ',
    btn_peace_lover:     'ผู้รักสันติภาพ',
    remind_btn:          '🔔 เตือน',
    remind_sent:         '✓ ส่งแล้ว',
    reminder_banner:     'เพื่อนเชิญให้คุณเลือกสันติภาพวันนี้!',
    nav_market:   'ร้านค้า',
    market_tagline:'ร้านค้าสันติภาพ',
    market_search:'ค้นหา…',
    market_from:  'ตั้งแต่',
    market_buy:   '🛍 ซื้อ',
    market_prev:  '← ก่อน',
    market_next:  'ถัดไป →',
    market_empty: 'ไม่พบสินค้า',
    market_error: 'โหลดล้มเหลว',
    streak_title:        'สถิติสันติภาพ',
    streak_days_row:     'วันติดต่อกัน',
    streak_days_unit:    'วัน',
    streak_seedling:     'เมล็ด',
    streak_keeper:       'ผู้พิทักษ์',
    streak_warrior:      'นักรบ',
    streak_champion:     'แชมเปี้ยน',
    streak_legend:       'ตำนาน',
  ...
  ja: {
    ...
    nav_stats:          '統計',
    nav_market:         'ショップ',
    stats_tagline:      'グローバル統計',
    stats_overview:     '概要',
    stats_total_votes:  '総投票数',
    stats_today:        '今日',
    stats_countries:    '国',
    stats_users:        'ユーザー',
    stats_top_countries:'トップ国',
    stats_leaderboard:  '🏆 トップ平和愛好者',
    lbl_country:        '国',
    lbl_age:            '年齢',
    lbl_gender:         '性別',
    ...
    save_btn:           '保存',
    close_btn:          '閉じる',
    id_info_visible_title: '全員に表示',
    id_info_visible_body:  'あなたのニックネームは公開名です。すべてのNAVA PEACEメンバーが平和メッセージとマップで確認できます。',
    id_info_msg_title:     '平和メッセージ',
    id_info_msg_body:      '平和メッセージを共有すると、世界地図にあなたのニックネームと一緒に表示されます。',
    id_info_invite_title:  '招待とシェア',
    id_info_invite_body:   '友達を招待するときにニックネームが表示されます。いつでも1回変更できます。',
    copied_lbl:         '✓ コピー済み',
    popup_my_doves:     '私のハト',
    ...
    mission_p1:         'NAVA PEACEは毎日のグローバルムーブメントです。 毎日、あらゆる国の人々が 一つのシンプルな約束をします： <strong>平和を選ぶこと。</strong>',
    ...
    personal_streak:    'あなたは平和を選びました<br>{days}日連続',
    ...
    press_hint:          'タップして\n平和を\n選ぼう',
    next_action_in:      '次のアクションまで',
    tap_to_see_map:      'マップを\n見る',
    btn_thank_you:       'ありがとう',
    btn_peace_lover:     '平和を愛する人',
    remind_btn:          '🔔 リマインド',
    remind_sent:         '✓ 送信済み',
    reminder_banner:     '友人が今日平和を選ぶよう招待しています！',
    nav_market:   'ショップ',
    market_tagline:'平和ショップ',
    market_search:'検索…',
    market_from:  'から',
    market_buy:   '🛍 購入',
    market_prev:  '← 前へ',
    market_next:  '次へ →',
    market_empty: '商品なし',
    market_error: '読み込みエラー',
    streak_title:        '平和ストリーク',
    streak_days_row:     '日連続',
    streak_days_unit:    '日',
    streak_seedling:     '芽生え',
    streak_keeper:       '守護者',
    streak_warrior:      '戦士',
    streak_champion:     'チャンピオン',
    streak_legend:       'レジェンド',
  ...
  my: {
    ...
    nav_market:         'ဈေး',
    stats_tagline:      'ကမ္ဘာလုံးဆိုင်ရာ စာရင်းအင်း',
    stats_overview:     'ခြုံငုံသုံးသပ်ချက်',
    stats_total_votes:  'စုစုပေါင်း မဲများ',
    stats_today:        'ယနေ့',
    stats_countries:    'နိုင်ငံများ',
    stats_users:        'အသုံးပြုသူများ',
    stats_top_countries:'ထိပ်တန်းနိုင်ငံများ',
    stats_leaderboard:  '🏆 ငြိမ်းချမ်းရေးချစ်သူများ',
    lbl_country:        'နိုင်ငံ',
    lbl_age:            'အသက်',
    lbl_gender:         'လိင်',
    ...
    close_btn:          'ပိတ်ပါ',
    id_info_visible_title: 'လူတိုင်းမြင်နိုင်သည်',
    id_info_visible_body:  'သင်၏ကလောင်နာမည်သည် သင်၏အများသူငှာနာမည်ဖြစ်သည်။ NAVA PEACE အဖွဲ့ဝင်များအားလုံး ငြိမ်းချမ်းရေးစာများနှင့် မြေပုံပေါ်တွင် မြင်နိုင်သည်။',
    id_info_msg_title:     'ငြိမ်းချမ်းရေးသတင်းစကားများ',
    id_info_msg_body:      'ငြိမ်းချမ်းရေးသတင်းစကားမျှဝေသောအခါ ကမ္ဘာ့မြေပုံပေါ်တွင် သင်၏ကလောင်နာမည်နှင့်အတူ ပေါ်လာသည်။',
    id_info_invite_title:  'ဖိတ်ကြားခြင်းနှင့် မျှဝေခြင်း',
    id_info_invite_body:   'သူငယ်ချင်းများဖိတ်ကြားသောအခါ သင်၏ကလောင်နာမည် ပေါ်လာသည်။ ၎င်းကို မည်သည့်အချိန်မဆို တစ်ကြိမ်ပြောင်းနိုင်သည်။',
    ...
    firstname_label:    'အမည်',
    firstname_change_btn: 'တည်းဖြတ်ပါ',
    ...
    mission_p1:         'NAVA PEACE သည် နေ့စဉ် ကမ္ဘာ့လှုပ်ရှားမှုတစ်ခုဖြစ်သည်။ နေ့တိုင်း နိုင်ငံအသီးသီးမှ လူများသည် ရိုးရှင်းသောကတိကဝတ်တစ်ခုကို ပေးကြသည်: <strong>ငြိမ်းချမ်းရေးကို ရွေးချယ်ခြင်း</strong>',
    ...
    personal_streak:    'သင်သည် ငြိမ်းချမ်းရေးကို ရွေးချယ်ခဲ့သည်<br>{days} ရက်ဆက်တိုက်',
    ...
    next_action_in:      'နောက်တစ်ကြိမ်',
    tap_to_see_map:      'မြေပုံကြည့်ရန်\nနှိပ်ပါ',
    btn_thank_you:       'ကျေးဇူးတင်ပါသည်',
    btn_peace_lover:     'ငြိမ်းချမ်းရေးချစ်သူ',
    remind_btn:          '🔔 သတိပေးပါ',
    remind_sent:         '✓ ပို့ပြီး',
    reminder_banner:     'သူငယ်ချင်းတစ်ယောက် ယနေ့ ငြိမ်းချမ်းရေးရွေးရန် ဖိတ်ခေါ်သည်!',
    nav_market:          'ဆိုင်',
    market_tagline:      'ငြိမ်းချမ်းသည်ဆိုင်',
    market_search:       'ရှာဖြေပါ…',
    market_from:         'မှ',
    market_buy:          '🛍 ဝယ်ပါ',
    market_prev:         '← နောက်',
    market_next:         'ရှေ့ →',
    market_empty:        'ကုန်ပစ္စည္မရှိ',
    market_error:        'တင်ခြင်းမအောင်မြိပြ',
    streak_title:        'ငြိမ်းချမ်းရေး ဆက်တိုက်',
    streak_days_row:     'ရက်ဆက်တိုက်',
    streak_days_unit:    'ရက်',
    streak_seedling:     'မျိုးစေ့',
    streak_keeper:       'စောင့်ရှောက်သူ',
    streak_warrior:      'စစ်သည်',
    streak_champion:     'ချန်ပီယံ',
    streak_legend:       'ဒဏ္ဍာရီ',
  ...
  hi: {
    ...
    nav_stats:          'आंकड़े',
    nav_market:         'बाज़ार',
    stats_tagline:      'वैश्विक आंकड़े',
    stats_overview:     'अवलोकन',
    stats_total_votes:  'कुल मत',
    stats_today:        'आज',
    stats_countries:    'देश',
    stats_users:        'उपयोगकर्ता',
    stats_top_countries:'शीर्ष देश',
    stats_leaderboard:  '🏆 शीर्ष शांति प्रेमी',
    lbl_country:        'देश',
    lbl_age:            'आयु',
    lbl_gender:         'लिंग',
    ...
    save_btn:           'सहेजें',
    close_btn:          'बंद करें',
    id_info_visible_title: 'सभी को दिखाई देता है',
    id_info_visible_body:  'आपका छद्मनाम आपका सार्वजनिक नाम है। सभी NAVA PEACE सदस्य इसे शांति संदेशों और मानचित्र पर देख सकते हैं।',
    id_info_msg_title:     'शांति संदेश',
    id_info_msg_body:      'जब आप शांति संदेश साझा करते हैं, तो यह विश्व मानचित्र पर आपके छद्मनाम के साथ दिखाई देता है।',
    id_info_invite_title:  'आमंत्रित करें और साझा करें',
    id_info_invite_body:   'मित्रों को आमंत्रित करते समय आपका छद्मनाम दिखाई देता है। आप इसे कभी भी एक बार बदल सकते हैं।',
    ...
    firstname_change_btn: 'संपादित करें',
    ...
    mission_p1:         'NAVA PEACE एक वैश्विक दैनिक आंदोलन है। हर दिन, हर देश के लोग एक सरल प्रतिबद्धता करते हैं: <strong>शांति चुनना।</strong>',
    ...
    personal_streak:    'आपने शांति चुनी है<br>{days} दिनों से लगातार',
    ...
    press_hint:          'दबाएं\nशांति\nचुनें',
    next_action_in:      'अगली क्रिया में',
    tap_to_see_map:      'नक्शा देखने\nके लिए टैप करें',
    btn_thank_you:       'धन्यवाद',
    btn_peace_lover:     'शांति प्रेमी',
    remind_btn:          '🔔 याद दिलाएं',
    remind_sent:         '✓ भेजा',
    reminder_banner:     'एक दोस्त आज शांति चुनने के लिए आमंत्रित करता है!',
    nav_market:          'बाज़ार',
    market_tagline:      'शांति बाज़ार',
    market_search:       'खोजें…',
    market_from:         'से',
    market_buy:          '🛍 खरीदें',
    market_prev:         '← पिछला',
    market_next:         'अगला →',
    market_empty:        'कोई उत्पाद नहीं।',
    market_error:        'लोड विफल।',
    streak_title:        'शांति श्रृंखला',
    streak_days_row:     'दिन लगातार',
    streak_days_unit:    'दिन',
    streak_seedling:     'अंकुर',
    streak_keeper:       'रक्षक',
    streak_warrior:      'योद्धा',
    streak_champion:     'चैंपियन',
    streak_legend:       'महापुरुष',
  ...
  uk: {
    // Common
    tagline:            'СЬОГОДНІ ЛЮДСТВО ОБИРАЄ МИР',
    nav_peace:          'МИР',
    nav_map:            'КАРТА',
    nav_profile:        'ПРОФІЛЬ',
    nav_about:          'ПРО НАС',
    nav_stats:          'СТАТИСТИКА',
    nav_market:         'МАГАЗИН',
    stats_tagline:      'ГЛОБАЛЬНА СТАТИСТИКА',
    stats_overview:     'ОГЛЯД',
    stats_total_votes:  'ВСЬОГО ГОЛОСІВ',
    stats_today:        'СЬОГОДНІ',
    stats_countries:    'КРАЇНИ',
    stats_users:        'КОРИСТУВАЧІ',
    stats_top_countries:'ТОП КРАЇНИ',
    stats_leaderboard:  '🏆 ТОП МИРОЛЮБНИХ',
    // Registration
    lbl_country:        'Країна',
    lbl_age:            'Вік',
    lbl_gender:         'Стать',
    ph_country:         'Оберіть вашу країну',
    ph_age:             'Введіть ваш вік',
    ph_gender:          'Оберіть',
    gender_male:        'Чоловіча',
    gender_female:      'Жіноча',
    gender_other:       'Інша',
    gender_pns:         'Не бажаю вказувати',
    btn_join:           'ПРИЄДНАТИСЯ ДО КАРТИ МИРУ',
    footer_note:        'БУДЬ ЗМІНАМИ, ЯКІ ХОЧЕШ БАЧИТИ У СВІТІ',
    // Peace page
    msg_for1:           'СЬОГОДНІ, ЗАРАДИ МЕНЕ,',
    msg_for2:           'ЗАРАДИ ТЕБЕ, ЗАРАДИ НАС,',
    msg_want:           'Я ХОЧУ МИРУ',
    msg_for3:           'У ВСЬОМУ СВІТІ',
    done_thank:         'ДЯКУЮ, ЗАХИСНИКУ МИРУ',
    done_sub:           'ВИ ОБРАЛИ МИР СЬОГОДНІ',
    done_timer_label:   'НАСТУПНА ДІЯ ЧЕРЕЗ',
    cnt_today_lbl:      'СЬОГОДНІ',
    cnt_total_lbl:      'УСЬОГО ДІЙ',
    // Map page
    lbl_peace_lovers:   'ЗАХИСНИКІВ МИРУ',
    lbl_countries:      'ПРЕДСТАВЛЕНИХ КРАЇН',
    lbl_today_map:      'ДІЙ СЬОГОДНІ У СВІТІ',
    lbl_days:           'ДНІВ',
    lbl_since:          'З МОМЕНТУ ЗАПУСКУ',
    lbl_follow:         'ПІДПИСУЙТЕСЬ',
    // Profile page
    profile_tagline:    'ПРОФІЛЬ СПІЛЬНОТИ',
    section_profile:    'MY PROFILE',
    section_doves:      'МОЇ ГОЛУБИ',
    dove_total_lbl:     'УСЬОГО ГОЛУБІВ',
    dove_own_lbl:       'ВЛАСНІ\nДІЇ',
    dove_ref_lbl:       'РЕФЕРАЛЬНІ\nГОЛУБИ',
    section_invite:     'ЗАПРОСИТИ ДРУЗІВ',
    copy_btn:           'КОПІЮВАТИ',
    lbl_friends:        'ДРУЗІ',
    lbl_invited:        'ЗАПРОШЕНІ',
    lbl_doves:          'ГОЛУБИ',
    lbl_from_actions:   'ВІД ЇХНІХ ДІЙ',
    section_age:        'РОЗПОДІЛ ЗА ВІКОМ',
    section_gender:     'РОЗПОДІЛ ЗА СТАТТЮ',
    edit_btn:           'РЕДАГУВАТИ',
    cancel_btn:         'СКАСУВАТИ',
    save_btn:           'ЗБЕРЕГТИ',
    close_btn:          'ЗАКРИТИ',
    id_info_visible_title: 'ВИДНО ВСІМ',
    id_info_visible_body:  "Ваш псевдонім — це ваше публічне ім'я. Усі члени NAVA PEACE бачать його в мирних посланнях і на карті.",
    id_info_msg_title:     'МИРНІ ПОСЛАННЯ',
    id_info_msg_body:      "Коли ви ділитесь мирним посланням, воно з'являється з вашим псевдонімом на карті світу.",
    id_info_invite_title:  'ЗАПРОСИТИ І ПОДІЛИТИСЯ',
    id_info_invite_body:   'Ваш псевдонім відображається при запрошенні друзів. Ви можете змінити його один раз у будь-який час.',
    copied_lbl:         '✓ СКОПІЙОВАНО',
    popup_my_doves:     'МОЇ ГОЛУБИ',
    popup_own_lbl:      'ВЛАСНІ ДІЇ',
    popup_ref_lbl:      'РЕФЕРАЛЬНІ',
    no_data_profile:    'СПОЧАТКУ ПРОГОЛОСУЙТЕ, ЩОБ ПОБАЧИТИ ПРОФІЛЬ',
    lbl_country_badge:  'КРАЇНА',
    lbl_age_badge:      'ВІК',
    lbl_gender_badge:   'СТАТЬ',
    lbl_days_badge:     'ДНІВ',
    lbl_edit_country:   'КРАЇНА (2-ЛІТЕРНИЙ КОД)',
    lbl_select:         '— ОБЕРІТЬ —',
    generating_link:    'ГЕНЕРАЦІЯ ПОСИЛАННЯ...',
    section_identity:   'МОЯ ІДЕНТИЧНІСТЬ',
    pseudo_change_btn:  'ЗМІНИТИ',
    pseudo_auto_tag:    'АВТО',
    pseudo_placeholder: 'Ваш псевдонім...',
    firstname_label:    "ІМ'Я",
    firstname_change_btn: 'РЕДАГУВАТИ',
    section_message:    'МОЄ ПОСЛАННЯ МИРУ',
    msg_placeholder:    'Напишіть ваше послання миру...',
    share_lbl:          'Поділитися публічно',
    msg_save_btn:       'ЗБЕРЕГТИ ПОСЛАННЯ',
    msg_saved_lbl:      '✓ ЗБЕРЕЖЕНО',
    peace_msg_title:    'ПОСЛАННЯ МИРУ',
    no_msgs_yet:        'Будьте першим, хто поділиться посланням миру.',
    // About page
    about_tagline:      'ПРО РУХ',
    mission_lbl:        'Наша місія',
    mission_p1:         'NAVA PEACE — це глобальний щоденний рух. Щодня люди з усіх країн беруть на себе просте зобов\'язання: <strong>Обрати мир.</strong>',
    mission_p2:         'Наша мета — показати в реальному часі, на живій карті світу, що людство обирає мир. Не як мрію. Як щоденний вчинок.',
    how_lbl:            'Як це працює',
    step1_title:        'Зареєструйтесь',
    step1_desc:         'Приєднайтесь раз. Вкажіть країну, вік і стать. Без облікового запису, без пароля, без email — ваша конфіденційність захищена.',
    step2_title:        'Обирайте мир щодня',
    step2_desc:         'Повертайтесь кожного дня і натискайте кнопку. Ваш голос враховується на глобальній карті. Кожен клік — це справжнє зобов\'язання.',
    step3_title:        'Запрошуйте друзів',
    step3_desc:         'Отримайте унікальний персональний код. Поділіться через WhatsApp, Telegram, Instagram або SMS. Кожен друг, який приєднається, розширює рух.',
    step4_title:        'Заробляйте голубів',
    step4_desc:         'Ваш мирний вплив зростає щодня. Отримуйте голуба за кожен день дії та ще одного за кожен день дії запрошеного друга.',
    dove_lbl:           'Голуб',
    dove_score:         'Ваш рахунок миру',
    dove_desc:          'Голуб — символ індивідуального впливу NAVA PEACE.\nВін винагороджує послідовність та надихає інших приєднатися.\nКожен голуб — це справжній акт миру —\nваш або того, кого ви надихнули.',
    dove_per_day:       '+1 Голуб\nЗа кожен\nдень дії',
    dove_per_friend:    '+1 Голуб\nЗа кожну\nдію друга',
    principles_lbl:     'Наші принципи',
    p_anon_name:        'Анонімність',
    p_anon_text:        'Без імені, без email. Ми збираємо лише країну, вік та стать, щоб зрозуміти, хто обирає мир.',
    p_univ_name:        'Універсальність',
    p_univ_text:        'Відкритий для кожної людини на Землі, з будь-якої країни, культури та середовища.',
    p_daily_name:       'Щоденність',
    p_daily_text:       'Мир — це не одноразова дія. Повернення щодня — це те, що робить рух справжнім і потужним.',
    p_free_name:        'Безкоштовність',
    p_free_text:        'Завжди безкоштовно. Без підписок, без реклами, без монетизації. Це рух, а не продукт.',
    p_trans_name:       'Прозорість',
    p_trans_text:       'Усі дані публічні та видимі на живій карті світу. Жодних прихованих цифр, жодних маніпуляцій.',
    cta_btn:            '🕊  Приєднатися до карти миру',
    welcome_back:       'З ПОВЕРНЕННЯМ, ЗАХИСНИКУ МИРУ',
    personal_streak:    'ВИ ОБИРАЛИ МИР<br>{days} ДЕНЬ(ДНІВ) ПОСПІЛЬ',
    pop_dot_label:      'Кожна точка = {perDotM}М людей',
    pop_people_text:    'З 8,2 мільярдів людей на Землі.\n\nКожен великий рух\nпочинається з іскри. 🕊',
    pop_of_world:       'СВІТУ',
    pop_countries_of:   '{count} з {total} країн',
    pop_countries_text: 'Мир не знає кордонів.\nКожна країна, що приєднується,\nнаближає нас до мирного світу.',
    pop_today_text:     'Мирних дій сьогодні\nпо всьому світу.\n\nКожен день — новий шанс.\nКожен клік — справжнє зобов\'язання\nобрати мир.',
    referrals_title:    'МОЇ РЕФЕРАЛИ',
    referrals_see_btn:  'ПЕРЕГЛЯНУТИ РЕФЕРАЛИ',
    referrals_empty:    'Поки що немає рефералів.\nПоділіться посиланням,\nщоб розширити рух миру!',
    press_hint:          'НАТИСНІТЬ\nЩОБ ОБРАТИ\nМИР',
    next_action_in:      'НАСТУПНА ДІЯ ЧЕРЕЗ',
    tap_to_see_map:      'НАТИСНІТЬ ДЛЯ\nКАРТИ',
    btn_thank_you:       'ДЯКУЮ',
    btn_peace_lover:     'ЛЮБИТЕЛЬ МИРУ',
    remind_btn:          '🔔 НАГАДАТИ',
    remind_sent:         '✓ НАДІСЛАНО',
    reminder_banner:     'Друг запрошує вас обрати мир сьогодні!',
    nav_market:          'МАГАЗИН',
    market_tagline:      'МАГАЗИН МИРУ',
    market_search:       'ПОШУК ТОВАРІВ…',
    market_from:         'ВІД',
    market_buy:          '🛍 КУПИТИ',
    market_prev:         '← ПОПЕРЕДНІЙ',
    market_next:         'НАСТУПНИЙ →',
    market_empty:        'ТОВАРІВ НЕ ЗНАЙДЕНО.',
    market_error:        'ПОМИЛКА ЗАВАНТАЖЕННЯ.',
    streak_title:        'СЕРІЯ МИРУ',
    streak_days_row:     'ДНІВ ПОСПІЛЬ',
    streak_days_unit:    'ДНІВ',
    streak_seedling:     'ПАРОСТОК',
    streak_keeper:       'ОХОРОНЕЦЬ',
    streak_warrior:      'ВОЇН',
    streak_champion:     'ЧЕМПІОН',
    streak_legend:       'ЛЕГЕНДА',
